...
from smsapp.models import Courses
...
class AddStudentForm(forms.Form):
    ...
    profile_pic=forms.FileField(label="Profile Pic",max_length=50,required=False,widget=forms.FileInput(attrs={"class":"form-control"}))
